...
async def send_movie_updates(bot, file_name, caption, file_id):
    try:
        ...
        btn = [[
            InlineKeyboardButton('📂 ɢᴇᴛ ғɪʟᴇ 📂', url=f'https://telegram.me/N2_Movies_Bot?start=getfile-{search_movie}')
        ]]
        ...
        if poster_url:
            ...
            no_poster = "https://graph.org/file/012b6d30c8cac09ea3e06.jpg"
            await bot.send_photo(movie_update_channel if movie_update_channel else MOVIE_UPDATE_CHANNEL, 
